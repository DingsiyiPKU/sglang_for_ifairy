...
def main():
    ...
    len = 5
    norm = 'norm'
    input_path = "/home/wangyuxing/Fairy-plus-minus-i-700M-quantized.safetensors"                   #需要转化的模型路径
    output_path = "/home/wangyuxing/sglang-Fairy-plus-minus-i-700M/model.safetensors"        #转化后模型保存路径
